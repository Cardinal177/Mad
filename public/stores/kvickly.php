...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .site-header { position: sticky; top: 0; z-index: 100; background: #c31414; color: white; box-shadow: 0 2px 12px rgba(0,0,0,0.18); }
        ...
        .store-hero { background: linear-gradient(135deg,#c31414 0%,#8d1419 100%); color: white; padding: 28px 20px 24px; }
        ...
        .spinner { width: 36px; height: 36px; border: 3px solid rgba(195,20,20,0.15); border-top-color: var(--accent); border-radius: 50%; animation: spin 0.75s linear infinite; }
    ...
    <div class="header-inner">
        ...
        <div class="header-brand">
            <svg viewBox="0 0 180 38" xmlns="http://www.w3.org/2000/svg">
                <text y="32" font-family="Arial Black,Arial,sans-serif" font-size="36" font-weight="900" fill="white">kvickly</text>
            </svg>
        </div>
    ...
    <div class="hero-inner">
        <div class="store-logo-box">
            <svg viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg" width="72" height="72">
                <circle cx="40" cy="40" r="40" fill="#c31414"/>
                <text x="40" y="48" font-family="Arial Black,Arial,sans-serif" font-size="36" font-weight="900" fill="#fff" text-anchor="middle" dominant-baseline="middle">K</text>
            </svg>
        </div>
        <div class="hero-text">
            <h1>Kvickly Tilbud</h1>
...
<div class="controls-wrap">
    <div class="controls-inner">
        <div class="search-box">
            ...
            <input type="text" id="searchInput" class="search-input" placeholder="Søg i Kvickly tilbud…">
        </div>
